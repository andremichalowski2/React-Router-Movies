...
* [x] When a user clicks on the movie card inside `MovieList` 
      - [x] they should be taken to `/movies/{id of clicked movie here}` to see the details of the selected movie.
